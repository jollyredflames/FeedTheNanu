...
public class MemoryGameActivity extends AppCompatActivity implements View.OnClickListener, SlidingTileGameDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (save != null) {
            ...
            MemoryGame game = new MemoryGame(save);
            this.size = save.size;
            ...
            // Create a new game
            this.size = size;
            MemoryGame game = new MemoryGame(this.size);
